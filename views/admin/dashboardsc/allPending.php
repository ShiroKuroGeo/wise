        ...
        <div id="application">
            ...
            <div id="content" class="app-content">
                ...
                <div class="d-flex justify-content-between">
                    <h1 class="page-header"><span class="fw-bolder text-capitalize">Pending <small> Tables </small></h1>
                    <div class="col-2">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title" id="concernTitle">Employee Concern - Table - Concern - Pending</h4>
                        <h4 class="panel-title visually-hidden" id="jobOrderTitle">Employee Concern - Table - Job - Pending</h4>
                    ...
                    <div class="panel-body">
                        <table id="data-table-default" class="table table-striped table-bordered align-middle w-100 text-nowrap">
                            ...
                            <tbody class="first" id="concernTableBody">
                                <tr class="odd gradeX" v-for="req of allRequestsPending">
                                    ...
                                    <td class="text-center">
                                        <a href="#ticketid" class="btn col-6" data-bs-toggle="modal" @click="viewPictureRequest(req.request_id)">View</a>
                            ...
                            <tbody class="visually-hidden" id="jobOrderTableBody">
                                <tr class="odd gradeX" v-for="ord of allOrdersPending">
