        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class=" mt-5">
                <div class="text-center">
                    <h1>Successfully Added to <br> <span class="text-primary">IT Department Accounts</span></h1>
                </div>
                <img src="../img/alerts/agree.png" alt="" class="img-fluid rounded" width="450">
                <div class="text-center">
                    <!-- <a href="/wise/views/admin/index.php" class="btn btn-primary col-5 mt-5">Okay</a> -->
